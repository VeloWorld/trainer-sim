...
- [x] **Phase 1: Vendored FTMS Codec** - Byte-correct IndoorBikeData encoder gated on spec-cited MIT decoder round-trip + hand-computed byte fixtures + one-shot nRF Connect manual verification (completed 2026-05-14)
- [x] **Phase 2: FIT Loader & Normalization** - Real Garmin/Wahoo FIT files become a clean RideRecord stream (completed 2026-05-16)
- [x] **Phase 3: Replay Engine** - Drift-corrected real-time scheduler with clean cancellation and loop/stop semantics (completed 2026-05-16)
...
- [x] **Phase 5: VeloWorld End-to-End Validation** - VeloWorld's dev/test build runs green against a real FIT replayed through FakeTransport on macOS and Linux (completed 2026-05-19)
...
|-------|----------------|----------|------------|
| 1. Vendored FTMS Codec | 5/5 | Complete | 2026-05-14 |
| 2. FIT Loader & Normalization | 5/5 | Complete | 2026-05-16 |
| 3. Replay Engine | 4/4 | Complete | 2026-05-16 |
| 4. FakeTransport & Public API | 6/6 | Complete | 2026-05-16 |
| 5. VeloWorld End-to-End Validation | 4/4 | Complete | 2026-05-19 |
