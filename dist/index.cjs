...
var FitParser__default = /*#__PURE__*/_interopDefault(FitParser);
...
var log = debuglog("trainer-sim:fit");
...
// src/fit/loader.ts
var log2 = debuglog("trainer-sim:fit");
...
function makeFitFileParserSource() {
  return {
    parse(buffer) {
      const parser = new FitParser__default.default({ mode: "list", force: false });
      let parsed;
      let firstError;
...
async function runScheduler(input) {
  ...
  while (true) {
    ...
    if (cursor >= records.length) {
      ...
      cursor = 0;
      baseline = getNow();
      log3("runScheduler: loop iteration restart at baseline=%d", baseline);
    }
  }
}
...
var log4 = debuglog("trainer-sim:transport");
...
exports.FitCrcError = FitCrcError;
exports.FitLoadError = FitLoadError;
exports.FitTruncatedError = FitTruncatedError;
exports.InvalidFitHeaderError = InvalidFitHeaderError;
exports.NoRecordMessagesError = NoRecordMessagesError;
exports.createFakeTransport = createFakeTransport;
exports.encodeIndoorBikeData = encodeIndoorBikeData;
exports.loadFitFromBuffer = loadFitFromBuffer;
exports.loadFitFromPath = loadFitFromPath;
